...
export default function Login() {
  ...
  return (
    <div className="bg-background text-on-background min-h-screen flex flex-col items-center justify-center font-body-md text-body-md antialiased selection:bg-primary-container selection:text-on-primary">
      {/* Main Container */}
      <main className="w-full max-w-md px-margin-mobile md:px-0">
        {/* Header Wordmark */}
        <header className="text-center mb-12">
          <h1 className="font-display-lg text-display-lg text-primary tracking-tight">The Quiet Authority</h1>
        </header>
        ...
        <section className="bg-surface-container-lowest border border-outline-variant/30 rounded-lg p-8 md:p-12">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="relative flex items-center py-2">
              ...
              <span className="flex-shrink-0 mx-4 font-label-sm text-label-sm text-on-surface-variant">or continue with</span>
              <div className="flex-grow border-t border-outline-variant/30"></div>
            </div>

            {/* Google Button */}
            <button className="w-full py-3 px-4 bg-surface border border-outline-variant text-on-surface font-label-md text-label-md rounded-full hover:bg-surface-variant transition-colors duration-200 flex justify-center items-center gap-2" type="button">
            ...
            <button 
              onClick={() => navigate('/')} 
              className="w-full py-3 px-4 bg-transparent border border-outline-variant text-on-surface font-label-md text-label-md rounded-full hover:bg-surface-variant transition-colors duration-200 flex justify-center items-center gap-2" 
              type="button"
            >
